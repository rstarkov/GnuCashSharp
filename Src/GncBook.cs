...
public class GncBook
{
    ...
    /// <summary>Rebuilds the account balance cache for every account, forcefully.</summary>
    ...
    /// <summary>
    ///     Rebuilds the account balance cache, stored inside the GncSplits, so as to obtain the balance after the specified
    ///     split. Only rebuilds as much as is necessary.</summary>
    /// <param name="splitGuid">
    ///     The GUID of the split to be calculated.</param>
    /// <param name="force">
    ///     If true, previous cached values will be disregarded.</param>
    ...
    /// <summary>
    ///     Verifies whether all balsnaps match the actual account balance. Issues warnings about any mismatch, as well as
    ///     about balsnaps that cannot be parsed correctly.</summary>
    ...
    /// <summary>Warn about certain types of incorrectly recorded transactions.</summary>
