...
public class GncCommodity
{
    ...
    /// <summary>
    ///     Gets the time series of the exchange rate of this currency into the book's base currency. The rate is the value of
    ///     1 unit of commodity in terms of the base currency.</summary>
