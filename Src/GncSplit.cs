...
public class GncSplit
{
    ...
    /// <summary>Amount of change in transaction's currency.</summary>
    public decimal Value
    {
        get { return _value; }
    }

    /// <summary>Amount of change in the destination account's currency (i.e. in split's currency).</summary>
    ...
    /// <summary>Returns true if this split represents a balance snapshot.</summary>
    ...
    /// <summary>
    ///     Gets the balance snapshot value represented by this split. This should only be called if IsBalsnap returns true,
    ///     otherwise an <see cref="InvalidOperationException"/> will be thrown. If the value cannot be parsed a <see
    ///     cref="GncBalsnapParseException"/> will be thrown.</summary>
    ...
    /// <summary>
    ///     Converts this split's amount to the target currency. Uses the implicit transaction exchange rate if it can be
    ///     inferred from the splits of the transaction. Otherwise uses <see cref="GncAmount.ConvertTo()"/>.</summary>
...
/// <summary>
///     Thrown by <see cref="GncSplit.Balsnap"/> when the split is a balance snapshot but the snapshotted value cannot be
///     parsed.</summary>
